...
export const BUILDINGS = {
  ...
  storehouse: { name: 'Storehouse',   icon: '🏪', cost: { wood: 20, stone: 8 },  work: 10, mesh: 'storehouse', cap: 200,
    desc: 'A central store for the tribe’s goods.', effect: '+200 resource storage' },
  granary:    { name: 'Granary',      icon: '🌾', cost: { wood: 16, stone: 4 },  work: 8,  mesh: 'granary', produces: { food: 4 },
    desc: 'Stores and grows grain.', effect: '+4 food / day' },
  farm:       { name: 'Farm Plot',    icon: '🌱', cost: { wood: 8 },             work: 5,  mesh: 'farm', produces: { food: 5 },
    desc: 'Tilled land worked for crops.', effect: '+5 food / day' },
  lodge:      { name: 'Logging Lodge', icon: '🪵', cost: { wood: 14, stone: 4 }, work: 8,  mesh: 'lodge', produces: { wood: 5 },
    desc: 'Organizes the woodcutters.', effect: '+5 wood / day' },
  mine:       { name: 'Mine',         icon: '⛏️', cost: { wood: 10, stone: 10 }, work: 10, mesh: 'mine', produces: { stone: 4 },
  ...
  monument:   { name: 'Monument',     icon: '🏛️', cost: { stone: 30 },           work: 18, mesh: 'monument', faith: 0.35,
    desc: 'A great work raised in your name.', effect: 'Strong devotion + prestige' },
  palisade:   { name: 'Palisade',     icon: '🧱', cost: { wood: 12 },            work: 5,  mesh: 'palisade', defense: 1,
    desc: 'A wall of sharpened logs.', effect: '+1 defense vs raids & beasts' },
  watchtower: { name: 'Watchtower',   icon: '🗼', cost: { wood: 18, stone: 6 },  work: 10, mesh: 'watchtower', defense: 3,
  ...
  circle:     { name: 'Elder Circle', icon: '🔮', cost: { stone: 12, wood: 4 },  work: 8,  mesh: 'circle', insight: 6, tech: 'language',
