...
const MANIFEST = {
  ...
  monument: { file: 'monument.glb', height: 4.2 },
  farm:     { file: 'farm.glb',     height: 4.5 },
  lodge:    { file: 'lodge.glb',    height: 3.0 },
  mine:     { file: 'mine.glb',     height: 2.6 },
  storehouse: { file: 'storehouse.glb', height: 3.4 },
  circle:   { file: 'circle.glb',   height: 2.2 },
  palisade: { file: 'palisade.glb', height: 2.4 },
  deer:     { file: 'deer.glb',     height: 1.7 },
  boar:     { file: 'boar.glb',     height: 1.1 },
  wolf:     { file: 'wolf.glb',     height: 1.1 },
  mammoth:  { file: 'mammoth.glb',  height: 3.6 },
  fish:     { file: 'fish.glb',     height: 0.6 },
